    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          deprecated_field2_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void TestDeprecatedLite::InternalSwap(TestDeprecatedLite* other) {
  ...
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  deprecated_field3_.Swap(&other->deprecated_field3_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  swap(deprecated_field4_, other->deprecated_field4_);
  swap(deprecated_field_, other->deprecated_field_);
  swap(deprecated_field2_, other->deprecated_field2_);
}
